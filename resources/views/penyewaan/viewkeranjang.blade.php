        ...
        <div class="col-xl-12 col-lg-12 col-sm-12">
            <div class="card shadow mb-4">
                ...
                <div
                    ...
                    <!-- Tombol Tambah Data -->
                    <a href="{{url('penyewaan/checkout')}}" class="btn btn-success btn-icon-split btn-sm">
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    @foreach ($keranjang as $p)
                                        <tr>
                                            ...
                                            <td>
                                                    <a onclick="deleteConfirm(this); return false;" href="#" data-id="{{ $p->id_penyewaan_detail }}" class="btn btn-danger btn-circle">
...
<!-- Modal Delete -->
    <script>
        function deleteConfirm(e){
            ...
            var url3 = "{{url('penyewaan/destroypenyewaandetail/')}}";
