        ...
        <div class="col-xl-12 col-lg-12 col-sm-12">
            <div class="card shadow mb-4">
                ...
                <div
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">Grafik Penyewaan Motor Listrik</h6>
                ...
                <div class="card-body">
                        ...
                        <?php
                            foreach($grafik as $dt){
                                $waktu[] = $dt->waktu;
                                $jml_gesits[] = (int)$dt->jml_gesits;
                                $jml_volta[] = (int)$dt->jml_volta;
                                $jml_selis[] = (int)$dt->jml_selis;
                                $jml_alva_one[] = (int)$dt->jml_alva_one;
                            }
                        ?>   
                        <div class="chart-bar">
            ...
            datasets: [
                {
                    ...
                    borderColor: "#4e73df",
                    data: <?php echo json_encode($jml_gesits);?>,
                },
                {
                    label: "Volta",
                    ...
                    borderColor: "#4edf9e",
                    data: <?php echo json_encode($jml_volta);?>,
                },
                {
                    label: "Selis",
                    backgroundColor: "#d92e5e",
                    hoverBackgroundColor: "#ba1140",
                    borderColor: "#d92e5e",
                    data: <?php echo json_encode($jml_selis);?>,
                },
                {
                    label: "Alva One",
                    backgroundColor: "#baac11",
                    hoverBackgroundColor: "#ba8d11",
                    borderColor: "#baac11",
                    data: <?php echo json_encode($jml_alva_one);?>,
                }
            ],
        },
        options: {
