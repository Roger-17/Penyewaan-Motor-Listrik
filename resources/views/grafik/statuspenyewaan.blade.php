        ...
        <div class="col-xl-12 col-lg-12 col-sm-12">
            <div class="card shadow mb-4">
                ...
                <div
                    ...
                    <h6 class="m-0 font-weight-bold text-primary">Grafik Status Penyewaan</h6>
                ...
                <div class="card-body">
                        ...
                        <?php
                            foreach($grafik as $dt){
                                $status_penyewaan[] = $dt->status;
                                $jml_penyewaan[] = (int)$dt->jml_penyewaan;
                            }
                        ?>   
...
<script>
    ...
    type: 'doughnut',
    data: {
        labels: <?php echo json_encode($status_penyewaan)?>,
        datasets: [{
        data: <?php echo json_encode($jml_penyewaan)?>,
